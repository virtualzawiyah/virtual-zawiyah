    ...
    <Layout>
      ...
      <section className="py-16" style={{ background: "linear-gradient(135deg, #1B6B3A 0%, #145530 100%)" }}>
        <div className="container mx-auto px-4 text-center text-white">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            ...
            <h1 className="font-serif font-bold text-4xl md:text-5xl mb-4">Terms of Service</h1>
      ...
      <div className="bg-white border-b py-3">
        <div className="container mx-auto px-4 text-sm" style={{ color: "#888" }}>
          ...
          <span style={{ color: "#1B6B3A" }}>Terms of Service</span>
        </div>
      </div>
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm p-8 md:p-12">
            ...
            <div className="rounded-xl p-5 mb-10 border" style={{ background: "#E8F5EE", borderColor: "#1B6B3A22" }}>
              ...
              <p className="text-sm" style={{ color: "#555" }}>
                By accessing our website or enrolling in any course offered by Virtual Zawiyah, you agree to be bound by these Terms of Service and our <Link href="/privacy" className="underline font-medium" style={{ color: "#1B6B3A" }}>Privacy Policy</Link>. If you do not agree with any part of these terms, you must not use our services.
              </p>
            </div>
            ...
            <Section title="4. Fees, Payment, and Refunds">
              ...
              <p><strong>Payment:</strong> Payment is due in advance of the billing period unless a payment plan is agreed in writing. We use secure third-party payment processors; we do not store your full payment card details.</p>
              ...
              <p>Refund requests must be submitted in writing to <strong>info@virtualzawiyah.com</strong>.</p>
            </Section>
            ...
            <Section title="7. Intellectual Property">
              ...
              <p>You are granted a limited, non-exclusive, non-transferable licence to access and use our content solely for your personal educational purposes. You may not:</p>
              <ul className="list-disc list-inside space-y-1 pl-2">
            ...
            <Section title="8. Privacy and Data Protection">
              <p>
                Your use of our services is also governed by our <Link href="/privacy" className="underline font-medium" style={{ color: "#1B6B3A" }}>Privacy Policy</Link>, which describes how we collect, use, and protect your personal information in compliance with GDPR, CCPA, PDPO, and other applicable laws. Our Privacy Policy is incorporated into these Terms by reference.
              </p>
            </Section>
            ...
            <Section title="12. Governing Law and Dispute Resolution">
              ...
              <p>
                <strong>EU/UK consumers:</strong> You retain the right to bring proceedings in the courts of your country of residence and may also use the EU Online Dispute Resolution platform at <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="underline" style={{ color: "#1B6B3A" }}>ec.europa.eu/consumers/odr</a>.
              </p>
              <p>
