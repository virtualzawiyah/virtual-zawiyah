  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data?.user) {
        ...
        // Cache the role in user metadata and session cookie
        ...
        const getDashboardPath = (roleStr: string) => {
          switch (roleStr) {
            ...
            case 'academic_director': return '/director/dashboard'
    ...
    <div className="relative flex min-h-screen items-center justify-center bg-gradient-to-b from-[#E8F5EE] via-[#FAFAF7] to-[#FAFAF7] p-4 font-sans selection:bg-[#1B6B3A]/20 selection:text-[#1B6B3A]">
      ...
      <div className="relative z-10 w-full max-w-md overflow-hidden rounded-2xl border border-[#1B6B3A]/10 bg-white p-8 shadow-xl transition-all duration-300 hover:shadow-2xl">
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-xs font-bold uppercase tracking-widest text-[#1B6B3A] bg-[#1B6B3A]/10 px-3 py-1 rounded-full">
            Staff Portal
          </p>
        </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="staff@virtualzawiyah.com"
        ...
        <div className="mt-8 text-center text-xs text-gray-500">
          Student or Guardian? <a href="/login" className="font-bold text-[#1B6B3A] hover:underline">Student Login</a>
        </div>
      </div>
    </div>
  )
