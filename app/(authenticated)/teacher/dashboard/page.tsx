    ...
    <>
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm flex flex-col sm:flex-row justify-between sm:items-center gap-4 relative overflow-hidden">
              ...
              <div className="flex items-center gap-4">
                <div className="h-14 w-14 rounded-full bg-[#1B6B3A]/10 border border-[#1B6B3A]/20 flex items-center justify-center text-lg font-black text-[#1B6B3A] font-sans shrink-0">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs sm:text-sm text-zinc-650 font-sans font-medium">{selectedStudent?.courseName}</p>
                  <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-emerald-800 bg-[#E8F5EE] border border-emerald-200/80 px-3 py-1 rounded-lg">
                    <Calendar className="w-3.5 h-3.5 text-[#1B6B3A]" />
                    Schedule: {selectedStudent?.schedule_text || 'Flexible Schedule (Mon–Sat)'}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 self-start sm:self-auto flex-wrap">
                <a
                  href={`https://meet.virtualzawiyah.com/VZ-${teacherId}-${selectedStudent?.id}-${getYYYYMMDD()}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="rounded-xl bg-[#1B6B3A] hover:bg-[#1B6B3A]/90 text-white px-5 py-2.5 text-xs font-bold shadow-md active:scale-95 transition-all flex items-center gap-2 font-sans select-none"
                >
                  <Video className="h-4 w-4" />
                ...
                <button
                  ...
                  className="rounded-xl border border-zinc-300 bg-zinc-50 hover:bg-zinc-100 px-4 py-2.5 text-xs font-bold text-zinc-700 shadow-xs transition-all font-sans"
                >
                  Deselect Student
                </button>
              </div>
      ...
      <aside className="hidden lg:block lg:w-80 shrink-0 bg-[#FAFAF7] p-8 border-l border-zinc-200 space-y-6 overflow-y-auto h-full">
        ...
        {(() => {
          ...
          if (selectedStudent) {
            return (
              <div className="rounded-2xl border border-[#1B6B3A]/30 bg-[#E8F5EE]/50 p-5 shadow-sm space-y-3 font-sans">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold text-[#1B6B3A] uppercase tracking-widest bg-[#1B6B3A]/10 border border-[#1B6B3A]/20 px-2 py-0.5 rounded">
                    Selected Student Room
                  </span>
                  <span className="flex h-2.5 w-2.5 relative">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-emerald-500"></span>
                ...
                <div>
                  <h4 className="text-base font-bold text-zinc-900 font-serif">{selectedStudent.full_name}</h4>
                  <p className="text-[10px] text-zinc-500 mt-0.5 leading-none">{selectedStudent.courseName}</p>
                  <p className="text-[10px] text-emerald-800 font-semibold mt-2 flex items-center gap-1">
                    <Calendar className="h-3.5 w-3.5 text-[#1B6B3A]" /> {selectedStudent.schedule_text || 'Flexible Schedule'}
                  </p>
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-[#1B6B3A] text-white hover:bg-[#1B6B3A]/90 py-2.5 px-4 text-xs font-bold shadow-md transition-all active:scale-95"
                >
                  <Video className="h-4 w-4" />
